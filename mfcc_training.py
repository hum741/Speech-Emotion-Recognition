...
# Description:基于MFCC特征对训练模型
#!/usr/bin/env python
#-*- conding:utf-8 -*-
# Author: hum741
# CreatTime: 2021/9/19
# FileName: MFCC_training
# Description: 基于二维卷积网络对MFCC特征进行训练
...
#分割训练集测试集
x_train, y_train, x_val, y_val = Train_Val_Split(mfcc_data,labels)
